...
exports.processDevice = exports.processDevices = exports.createPDF = void 0;
...
const printDeviceBarcode = (type, mac, printer, port) => {
    ...
    return (0, exports.createPDF)(type, mac, port, outputPath)
        .catch((err) => {
        return err;
    })
        .then(() => {
...
const processDevices = (newDevices, devicesCollection, printer, port) => {
    newDevices.forEach((device) => {
        if (!devicesCollection.has((deviceID) => deviceID === device.id)) {
            const { mac, type } = (0, exports.processDevice)(device);
...
exports.processDevices = processDevices;
/**
...
exports.processDevice = processDevice;
// Import env
(0, dotenv_1.config)();
// Environment
...
router.get('/test', (req, res) => {
    const outputPath = './generated/out.pdf';
    return (0, exports.createPDF)('TPP2W-G2', '0.36.119.87.182.61', port, outputPath).then(() => {
...
function scan() {
    tibboDiscover.scan().then((devices) => {
        return (0, exports.processDevices)(devices, devicesDB, printer, port);
    });
}
app.use('/', router);
app.listen(port);
